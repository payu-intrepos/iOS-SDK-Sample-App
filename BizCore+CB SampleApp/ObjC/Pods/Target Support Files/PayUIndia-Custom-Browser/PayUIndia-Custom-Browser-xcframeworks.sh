...
install_xcframework "${PODS_ROOT}/PayUIndia-Custom-Browser/PayUCustomBrowser.xcframework" "PayUIndia-Custom-Browser" "framework" "ios-i386_x86_64-simulator" "ios-armv7_arm64"
