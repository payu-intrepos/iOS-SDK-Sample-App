...
install_xcframework "${PODS_ROOT}/PayUIndia-PayUParams/PayUParamsKit/PayUParamsKit.xcframework" "PayUParamsKit" "framework" "ios-i386_x86_64-simulator" "ios-armv7_arm64"
