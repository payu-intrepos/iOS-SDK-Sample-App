...
/*!
 * This method gets called when user presses back button
 * You must return YES from this if you want to show CB cancel view and return NO from this if you want to show your own view (like alert)
 */
- (BOOL)shouldShowCancelAlert;
/*!
