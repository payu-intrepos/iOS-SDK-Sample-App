...
- (void)onFailure:(id)message;
- (void)onFailure:(id)message responseCallback:(WVJBResponseCallback)responseCallback;
- (void)onSuccess:(id)message;
- (void)onSuccess:(id)message responseCallback:(WVJBResponseCallback)responseCallback;
