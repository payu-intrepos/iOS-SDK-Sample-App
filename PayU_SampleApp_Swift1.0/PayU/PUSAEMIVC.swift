  ...
  func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    if (tableView == tblBankDuration)
    {
      if let bankCodeTitle = currentCell.textLabel?.text
      {
        ...
        self.lblSelectMonth.setTitle(selectedBankAtIndex, for: UIControlState.normal)
        self.lblSelectYear.setTitle(bankCodeTitle, for: UIControlState.normal)
    ...
    if (tableView == tblExpiryMonth){
      ...
      self.lblExpiryMonth.setTitle(selectedIndexForExpiryMonth, for: UIControlState.normal)
      ...
      
    {
      ...
      self.lblExpiryYear.setTitle(selectedIndexForExpiryYear, for: UIControlState.normal)
